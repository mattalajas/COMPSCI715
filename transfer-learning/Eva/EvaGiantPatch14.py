...
# Load the eva_giant_patch14_224 model from timm
model = timm.create_model('eva_giant_patch14_224', pretrained=True)

# Modify the final layer for regression according to cols_to_predict
num_features = model.head.in_features
model.head = nn.Linear(num_features, len(cols_to_predict_value))
